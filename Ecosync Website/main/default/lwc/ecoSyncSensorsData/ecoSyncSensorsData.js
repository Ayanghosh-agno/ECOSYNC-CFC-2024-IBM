    ...
    @track sensorData = [
        {
            Id: 1,
            CreatedDate: '--/--/----, --:--:--',
            Atmosphere_Temperature__c: '0',
            Atmosphere_Humidity__c: '0',
            Rain_Percentage__c: '0',
            Light_Intensity__c: '0',
            Soil_Electric_Conductivity__c: '0',
            Soil_Moisture_Percentage__c: '0',
            Soil_Nitrogen__c: '0',
            Soil_Phosphorus__c: '0',
            Soil_Temperature__c: '0',
            Soil_Potassium__c: '0',
            Soil_Ph__c: '0',
            Transmitter_Battery__c: '0',
        },
    ];
